/*La partie http de ce code a été trouvée sur le site https://f-leb.developpez.com/tutoriels/arduino/esp8266/debuter/ */
#include <ESP8266WiFi.h>
#include <math.h>


/////////////////////////temperature sensing const and functions/////////////////////////////
...
const char* SSID = "Phoney McPhoneface";
const char* password = "laBlancheQuiquine09";
...
void loop() {
  ...
  client.println("<meta http-equiv=\"refresh\" content=\"2\">"); //to refresh the page every 2 seconds
  client.println("</head>");
  client.println("<body>");
